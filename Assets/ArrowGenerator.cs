...
public class ArrowGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.parent.localPosition = Vector3.zero - Vector3.down * 1000;
    }

    public void UpdateArrow(Vector3 position, Vector3 lookRot, float _stemLength)
    {
        transform.parent.rotation = Quaternion.LookRotation(lookRot, Vector3.up);
        stemLength = _stemLength;
